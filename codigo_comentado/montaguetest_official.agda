...
-- Definindo um módulo chamado "montaguetest_official".
module montaguetest_official where

-- Importando da biblioteca HoTT-Agda e importando o operador comonádico do arquivo "flat" e a lógica de homotopia do arquivo "logic".
